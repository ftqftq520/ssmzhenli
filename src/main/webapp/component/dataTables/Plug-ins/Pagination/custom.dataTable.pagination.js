$.fn.dataTableExt.oPagination.custom = {
    "fnInit": function ( oSettings, nPaging, fnCallbackDraw )
    {
        ...
        nFirst.style.cursor = "pointer";
        nPrevious.style.cursor = "pointer";
        nNext.style.cursor = "pointer";
        nLast.style.cursor = "pointer";
        nOf.style.cursor = "pointer";
