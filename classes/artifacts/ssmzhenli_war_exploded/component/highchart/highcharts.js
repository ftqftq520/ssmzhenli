...
defaultOptions = {
	colors: [
        '#45A2CB', '#2DA22A', '#FBB100', '#94E010', '#D71A25',
        '#AA19B6', '#0D549D', '#2CD7B9', '#FBF000', '#FB00F4'
    ],
	...
	lang: {
		...
		decimalPoint: '.',
		numericSymbols: null , //['k', 'M', 'G', 'T', 'P', 'E'], // SI prefixes used in axis labels  Modify by WYS
		resetZoom: '重置大小',
		resetZoomTitle: '重置图像大小为 1:1',
		thousandsSep: ','
	},
	global: {
		useUTC: true,
	...
	chart: {
		...
		//spacingLeft: 10,
		style: {
			fontFamily: '"微软雅黑", "宋体", "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif', // default font
			fontSize: '12px'
		},
